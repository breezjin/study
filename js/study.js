...
{
let enrolledStudents = students.filter(function(enroll){
...
{
let sortScore = students.map(function(scores) {
    let result = [];
    result.push = scores.score;
    return result;
})
console.log("7번");
...
{
let lowStudent = students.find(function(low){
    return low.score < 50;
})
console.log("8번");
...
{
    let sumScores = students.reduce(function (total, curr) {
...
// result should be: '45, 80, 90, 66, 88'
{
    let allScores = students.map(function(scores) {
        let arr = [];
